"""
CLASS-LAG Applicability Domain — z<=0.0 threshold (unweighted run)
-------------------------------------------------------------------
...
Changes vs. gdsc_classLAG_AD_z0.py (weighted):
  ...
  - TAG = 'z0_unwt'
  - Output files prefixed gdsc_classLAG_AD_z0_unwt_*
...
print(f"  Classifier       : RandomForest (unweighted)")
