"""
CLASS-LAG Applicability Domain — z<=0.0 threshold (sample_weight run)
------------------------------------------------------------------------
...
Changes vs. original gdsc_classLAG_applicability_domain.py:
  ...
  - Output files prefixed gdsc_classLAG_AD_z0_*
...
Z_THRESHOLD  = 0.0          # sensitive if z-score > 0.0
TAG          = 'z0'
TEST_SIZE    = 0.2
RANDOM_STATE = 42
N_ESTIMATORS = 100
...
for i, cell in enumerate(cell_lines):
    ...
    # Sample weights to match the weighted pipeline
